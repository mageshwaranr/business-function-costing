...
import static com.tt.xenon.common.reflect.ParamMetadata.Type.*;
...
public class MethodInfoBuilderTest {
  ...
  public void testParseDeleteApi() throws Exception {
    List<MethodInfo> httpMethods = MethodInfoBuilder.parseJaxRsMethodInfo(MockWithJaxRsParams.class);
  ...
  public void testMethodWithGenericReturnType() throws Exception {
    ...
    MethodInfoBuilder.parseReturnTypes(mInfo);
